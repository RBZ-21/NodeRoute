        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-3 md:grid-cols-4">
              ...
              <SelectInput value={quoteForm.status} onChange={(e) => setQuoteForm((f) => ({ ...f, status: e.target.value }))}>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-3 md:grid-cols-4">
              ...
              <SelectInput value={promotionForm.promo_type} onChange={(e) => setPromotionForm((f) => ({ ...f, promo_type: e.target.value }))}>
                {['sale_price', 'percent_off', 'dollar_off', 'buy_x_get_y'].map((type) => <option key={type} value={type}>{type}</option>)}
              </SelectInput>
              <SelectInput value={promotionForm.status} onChange={(e) => setPromotionForm((f) => ({ ...f, status: e.target.value }))}>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-3 md:grid-cols-4">
              ...
              <SelectInput value={rebateForm.rebate_type} onChange={(e) => setRebateForm((f) => ({ ...f, rebate_type: e.target.value }))}>
