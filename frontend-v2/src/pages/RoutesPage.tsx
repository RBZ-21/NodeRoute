...
import { RouteDispatchConfirmModal } from './RouteDispatchConfirmModal';
...
export function RoutesPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      <>
      {dispatchCandidate ? (
        <RouteDispatchConfirmModal
          route={dispatchCandidate}
          allStops={allStops}
          driverById={driverById}
          updateRoutePending={updateRoute.isPending}
          onClose={() => setDispatchCandidate(null)}
          onConfirm={confirmDispatchRoute}
        />
      ) : null}
      ...
      {editRoute ? (
        <RouteEditPanel
          ...
          onEditDriverChange={handleEditDriverChange}
          setEditDriverId={setEditDriverId}
          driverOptions={driverOptions}
          linkedEditDriver={linkedEditDriver}
          editNotes={editNotes}
          setEditNotes={setEditNotes}
          onSaveEdit={handleSaveEdit}
          updateRoutePending={updateRoute.isPending}
          onViewAllStops={(routeId) => switchTab('stops', { routeId })}
          onDeleteRoute={handleDeleteRoute}
          showOptimizeHint={showOptimizeHint}
          setShowOptimizeHint={setShowOptimizeHint}
          onRunOptimize={handleRunOptimize}
          stopSearch={stopSearch}
          setStopSearch={setStopSearch}
          setSelectedStopCustomerId={setSelectedStopCustomerId}
          selectedStopCustomerId={selectedStopCustomerId}
          stopOptions={stopOptions}
          onAddStopToRoute={handleAddStopToRoute}
          addingStop={addingStop}
          onRemoveStop={handleRemoveStop}
          pendingOrders={pendingOrders}
          batchPendingOrders={batchPendingOrders}
          selectedOrderIds={selectedOrderIds}
          onToggleOrder={toggleOrder}
          onAddOrdersAsStops={handleAddOrdersAsStops}
