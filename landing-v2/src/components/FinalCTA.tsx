...
export function FinalCTA() {
  return (
    <section className="relative mx-auto max-w-6xl px-6 pt-4 pb-28">
      <div className="relative overflow-hidden rounded-3xl border border-teal/30 bg-teal-deep p-10 md:p-14">
        ...
        <div className="relative">
          <div className="inline-flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.2em] text-teal-sky">
