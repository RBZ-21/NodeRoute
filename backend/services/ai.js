...
module.exports = {
  ...
  // Shared low-level helpers consumed by the extracted sub-modules (e.g.
  // ai-chat.js). Exported so those modules can require them without duplicating
  // logic; not part of the historical public surface but harmless to expose.
  getClient,
...
// Chat/conversation feature lives in ./ai-chat.js. It is required AFTER
// module.exports above is fully assigned so its lazy require('./ai') calls see
// the shared helpers. Spreading its exports here preserves the historical
// public surface (generateChatReply, generateChatReplyWithContext,
// checkChatRateLimit, heuristicChatReply) for all existing consumers.
const aiChat = require('./ai-chat');
Object.assign(module.exports, aiChat);
